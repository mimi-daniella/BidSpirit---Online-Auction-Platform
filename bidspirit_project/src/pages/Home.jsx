...
const Home = () => {
  ...
  React.useEffect(() => {
    if (inView) {
      controlsLeft.start({ x: 0, opacity: 1, transition: { type: "tween", duration: 0.8 } });
      controlsRight.start({ x: 0, opacity: 1, transition: { type: "tween", duration: 0.8 } });
    } else {
      controlsLeft.start({ x: "-100vw", opacity: 0, transition: { duration: 0.5 } });
      controlsRight.start({ x: "100vw", opacity: 0, transition: { duration: 0.5 } });
    }
